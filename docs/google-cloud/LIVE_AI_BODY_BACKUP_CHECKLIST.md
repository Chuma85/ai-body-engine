...
- [ ] Confirm all four preflight checks report `enforced`, `true`, `NORTHAMERICA-NORTHEAST2`, and raw JSON `storageClass: STANDARD` for public access prevention, uniform access, location, and storage class.
